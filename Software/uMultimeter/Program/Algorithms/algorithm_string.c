...
**====================================================================================================*/
/*====================================================================================================*/
void Str_NumToChar( StrType Type, uint8_t NumLen, int8_t *CharData, int32_t NumData )
{
  uint8_t i = 0;
...
**輸入 : *inputStr
**輸出 : StrLen
**使用 : StrLen = Str_LenOfStr((int8_t*)"Hello World!!");
**====================================================================================================*/
/*====================================================================================================*/
uint16_t Str_LenOfStr( int8_t *inputStr )
{
  uint16_t StrLen = 0;
