...
void OLED_DrawRect( uint8_t CoordiX, uint8_t CoordiY, uint8_t Width, uint8_t Height, uint16_t Color );
void OLED_DrawRectFill( uint8_t CoordiX, uint8_t CoordiY, uint8_t Width, uint8_t Height, uint16_t Color );
