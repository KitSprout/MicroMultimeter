...
#define KEY_U_GPIO_CLK_ENABLE()   __HAL_RCC_GPIOB_CLK_ENABLE()
...
#define KEY_D_GPIO_CLK_ENABLE()   __HAL_RCC_GPIOB_CLK_ENABLE()
#define KEY_D_Read()              (__GPIO_READ(KEY_D_GPIO_PORT, KEY_D_PIN) == KEY_D_PIN)

#define KEY_R_PIN                 GPIO_PIN_13
#define KEY_R_GPIO_PORT           GPIOC
#define KEY_R_GPIO_CLK_ENABLE()   __HAL_RCC_GPIOC_CLK_ENABLE()
...
#define KEY_P_GPIO_CLK_ENABLE()   __HAL_RCC_GPIOC_CLK_ENABLE()
...
#define KEY_L_GPIO_CLK_ENABLE()   __HAL_RCC_GPIOC_CLK_ENABLE()
#define KEY_L_Read()              (__GPIO_READ(KEY_L_GPIO_PORT, KEY_L_PIN) != KEY_L_PIN)
/*====================================================================================================*/
/*====================================================================================================*/
void UM_BSP_Init( void );
/*====================================================================================================*/
/*====================================================================================================*/
#endif
