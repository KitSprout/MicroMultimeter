...
#define LED_R_GPIO_CLK_ENABLE()   RCC_AHBPeriphClockCmd(RCC_AHBPeriph_GPIOB, ENABLE)
...
#define LED_G_GPIO_CLK_ENABLE()   RCC_AHBPeriphClockCmd(RCC_AHBPeriph_GPIOB, ENABLE)
...
#define LED_B_GPIO_CLK_ENABLE()   RCC_AHBPeriphClockCmd(RCC_AHBPeriph_GPIOB, ENABLE)
...
#define KEY_U_GPIO_CLK_ENABLE()   RCC_AHBPeriphClockCmd(RCC_AHBPeriph_GPIOB, ENABLE)
...
#define KEY_D_GPIO_CLK_ENABLE()   RCC_AHBPeriphClockCmd(RCC_AHBPeriph_GPIOB, ENABLE)
...
#define KEY_R_GPIO_CLK_ENABLE()   RCC_AHBPeriphClockCmd(RCC_AHBPeriph_GPIOC, ENABLE)
...
#define KEY_P_GPIO_CLK_ENABLE()   RCC_AHBPeriphClockCmd(RCC_AHBPeriph_GPIOC, ENABLE)
...
#define KEY_L_GPIO_CLK_ENABLE()   RCC_AHBPeriphClockCmd(RCC_AHBPeriph_GPIOC, ENABLE)
